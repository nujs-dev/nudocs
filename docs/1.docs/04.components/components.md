...
::tabs
  ...
  :pm-x{command="giget nujs new-lib"}
...
::tabs
  ...
  ---
  :read-more{to="/docs"}
  :read-more{to="https://nujs.dev" title="NuJS Website"}
  ::
  ::div
  ---
  label: Code
...
````
  ...
  B --> C[Content Transform]
      ...
      click A "/docs"
      click B "/docs/components/components"
      click C "/docs/components/content-transformation"
  ```
````
...
App-level component overrides are documented in [Customizations](/docs/customization/overview).
